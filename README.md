...
![테스트 659](https://img.shields.io/badge/테스트-659_케이스-22C55E)
...
<details>
<summary><b>27개 파일 · 659 케이스</b></summary>
...
| `thinking` | 37 | 생각 중 표시 — 켜지는 자리, 끄는 문을 다 막았는가, 커서가 세 곳에서 같은가 |
