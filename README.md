...
![테스트 1003](https://img.shields.io/badge/테스트-1003_케이스-22C55E)
...
<details>
<summary><b>30개 파일 · 1003 케이스</b></summary>
...
| `image` | 70 | 생성된 이미지 — tool 메시지에서 뽑는가 · 문자 블록 종횡비가 맞는가 |
...
| [이미지 생성 — 결과와 과정](docs/plan/2026-09-09-image-generation.md) | 1단계 동작 확인 (새로고침 후 표시) · 스트리밍 중 표시는 남음 |
