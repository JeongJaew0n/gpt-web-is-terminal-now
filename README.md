...
![테스트 742](https://img.shields.io/badge/테스트-742_케이스-22C55E)
...
<details>
<summary><b>28개 파일 · 742 케이스</b></summary>
...
조사·수정 기록은 [`docs/issue/`](docs/issue/README.md) 에 있다. **열두 건 중 아홉이 해결**됐다.
